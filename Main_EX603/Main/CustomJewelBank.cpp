	...
	if (this->JewelEnable == 1)
	{
		...
		for (int i = (MAX_ITEM_BANK * this->Page); i < (MAX_ITEM_BANK * this->Page) + MAX_ITEM_BANK; i++)
		{
			...
			switch (i)
			{
				...
				case 10: DrawItemText(StartX,StartBody, 0,  posyy, this->PosItemBank[10],  this->m_Data.ItemBank[10],14, 400,0, gConfig.TEXT_ENGINE[11],		7);break;
				case 11: DrawItemText(StartX,StartBody, 4,  posyy, this->PosItemBank[11],  this->m_Data.ItemBank[11],14, 401,0, gConfig.TEXT_ENGINE[12],		11);break;
				case 12: DrawItemText(StartX,StartBody, 8,  posyy, this->PosItemBank[12],  this->m_Data.ItemBank[12],14, 402,0, gConfig.TEXT_ENGINE[13],		15);break;
				case 13: DrawItemText(StartX,StartBody, 12, posyy, this->PosItemBank[13],  this->m_Data.ItemBank[13],14, 403,0, gConfig.TEXT_ENGINE[14],		19);break;
				case 14: DrawItemText(StartX,StartBody, 16, posyy, this->PosItemBank[14],  this->m_Data.ItemBank[14],14, 404,0, gConfig.TEXT_ENGINE[15],		23);break;
				case 15: DrawItemText(StartX,StartBody, 20, posyy, this->PosItemBank[15],  this->m_Data.ItemBank[15],14, 405,0, gConfig.TEXT_ENGINE[16],		27);break;
				case 16: DrawItemText(StartX,StartBody, 24, posyy, this->PosItemBank[16],  this->m_Data.ItemBank[16],14, 406,0, gConfig.TEXT_ENGINE[17],		31);break;
				case 17: DrawItemText(StartX,StartBody, 28, posyy, this->PosItemBank[17],  this->m_Data.ItemBank[17],14, 407,0, gConfig.TEXT_ENGINE[18],		35);break;
				case 18: DrawItemText(StartX,StartBody, 32, posyy, this->PosItemBank[18],  this->m_Data.ItemBank[18],14, 408,0, gConfig.TEXT_ENGINE[19],		39);break;
				case 19: DrawItemText(StartX,StartBody, 36, posyy, this->PosItemBank[19],  this->m_Data.ItemBank[19],14, 415,0, gConfig.TEXT_ENGINE[20],		43);break;
				case 20: DrawItemText(StartX,StartBody, 0,  posyy, this->PosItemBank[20],  this->m_Data.ItemBank[20],14, 409,0, gConfig.TEXT_ENGINE[21],		7);  break;
				case 21: DrawItemText(StartX,StartBody, 4,  posyy, this->PosItemBank[21],  this->m_Data.ItemBank[21],14, 410,0, gConfig.TEXT_ENGINE[22],		11); break;
				case 22: DrawItemText(StartX,StartBody, 8,  posyy, this->PosItemBank[22],  this->m_Data.ItemBank[22],14, 411,0, gConfig.TEXT_ENGINE[23],		15); break;
				case 23: DrawItemText(StartX,StartBody, 12, posyy, this->PosItemBank[23],  this->m_Data.ItemBank[23],14, 412,0, gConfig.TEXT_ENGINE[24],		19); break;
				case 24: DrawItemText(StartX,StartBody, 16, posyy, this->PosItemBank[24],  this->m_Data.ItemBank[24],14, 413,0, gConfig.TEXT_ENGINE[25],		23); break;
				case 25: DrawItemText(StartX,StartBody, 20, posyy, this->PosItemBank[25],  this->m_Data.ItemBank[25],14, 414,0, gConfig.TEXT_ENGINE[26],		27); break;
