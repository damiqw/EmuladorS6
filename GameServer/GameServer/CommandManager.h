...
enum eCommandNumber
{
	...
	COMMAND_STARTGVG		= 83,
	COMMAND_CUSTOM_MARRIAGE1 = 84,
	COMMAND_CUSTOM_MARRIAGE2 = 85,
	COMMAND_CUSTOM_MARRIAGE3 = 86,
	COMMAND_CUSTOM_MARRIAGE4 = 87,
...
public:
	...
	bool CommandItemChage(LPOBJ lpObj); //환전
	bool CommandAutoChage(LPOBJ lpObj); //오토환전
public:
