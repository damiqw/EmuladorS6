...
public:
	...
	int m_BlockSellShopPeriodicItem;
	int m_MaxLevel;
	int m_MaxLevelUp;
	...
	int m_CommandPostGlobalShowServerName;
#if(NEW_POSTITEM)
	int m_CommandPostItem;
	int m_CommandPostItemEnable[MAX_ACCOUNT_LEVEL];
	int m_CommandPostItemLevel[MAX_ACCOUNT_LEVEL];
	int m_CommandPostItemReset[MAX_ACCOUNT_LEVEL];
	int m_CommandPostItemMoney[MAX_ACCOUNT_LEVEL];
	int m_CommandPostItemCoin1[MAX_ACCOUNT_LEVEL];
	int m_CommandPostItemCoin2[MAX_ACCOUNT_LEVEL];
	int m_CommandPostItemCoin3[MAX_ACCOUNT_LEVEL];
	int m_CommandPostItemRuud[MAX_ACCOUNT_LEVEL];
	int m_CommandPostItemDelay[MAX_ACCOUNT_LEVEL];
#endif
	int m_CommandAddPointAutoEnable[MAX_ACCOUNT_LEVEL];
	int m_CommandChangeLimit[MAX_ACCOUNT_LEVEL];
	int m_CommandWareType;
	...
	int m_CommandResetRewardCoin1Value[MAX_ACCOUNT_LEVEL];
	int m_CommandResetRewardCoin2Value[MAX_ACCOUNT_LEVEL];
	int m_CommandResetRewardCoin3Value[MAX_ACCOUNT_LEVEL];
	int m_CommandResetRewardRuudValue[MAX_ACCOUNT_LEVEL];
	...
	int m_CommandMasterResetRewardCoin1Value[MAX_ACCOUNT_LEVEL];
	int m_CommandMasterResetRewardCoin2Value[MAX_ACCOUNT_LEVEL];
	int m_CommandMasterResetRewardCoin3Value[MAX_ACCOUNT_LEVEL];
	int m_CommandMasterResetRewardRuudValue[MAX_ACCOUNT_LEVEL];
	...
	DWORD m_AntihackDllCRC;
	DWORD m_MainDllCRC;
	DWORD m_MainExeCRC;
	DWORD m_PlayerBmdCRC;
	DWORD m_SkillBmdCRC;
	DWORD m_ItemBmdCRC;
