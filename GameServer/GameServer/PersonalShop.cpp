...
void CPersonalShop::CGPEquipShopSetItemPriceRecv(PMSG_PSHOP_SET_ITEM_PRICE_RECV* lpMsg, int aIndex) // OK
{
	...
	lpObj->EquipInventory[lpMsg->slot].m_PShopJoBValue = JoBPrice;

	lpObj->EquipInventory[lpMsg->slot].m_PShopJoSValue = JoSPrice;

	lpObj->EquipInventory[lpMsg->slot].m_PShopJoCValue = JoCPrice;
