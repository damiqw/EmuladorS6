...
void CServerInfo::ReadCustomInfo() // OK
{
	...
	gPartyRestore.ReadConfig("GameServerInfo",".\\Data\\GameServerInfo - Custom.dat");
	...
	gCustomBuyVip.ReloadBuyVipInterface();
	...
	#if(MAP_USAGE)
	gCB_MapUsageTime.Load(gPath.GetFullPath("Custom\\CustomMapUsage.txt"));
	#endif

	gCustomMonsterSkill.Load(gPath.GetFullPath("Custom\\CustomMonsterSkill.txt"));

	gPKZone.Load(gPath.GetFullPath("Custom\\CustomPvPZone.txt"));

	gInvoker.Load(gPath.GetFullPath("Custom\\CustomRingSummon.txt"));

	#if(CUSTOM_PET)
	gCustomPet.Load(gPath.GetFullPath("Custom\\CustomPet.txt"));
#endif

	gCustomBuffMonster.Load(gPath.GetFullPath("Custom\\CustomBuffMonster.txt"));

	gCustomMarriage.Load(gPath.GetFullPath("Custom\\CustomMarriage.txt"));

	gShopPointEx.Load(gPath.GetFullPath("Custom\\CustomBonusPoint.txt"));

	gCustomMonsterKillCount.Load(gPath.GetFullPath("Custom\\CustomMonsterKillCount.txt"));

	gCustomDeathReward.Load(gPath.GetFullPath("Custom\\CustomDeathReward.txt"));

	gCustomDropCoin.Load(gPath.GetFullPath("Custom\\CustomDropCoin.txt"));

	gCustomGuard.Load(gPath.GetFullPath("Custom\\CustomGuard.txt"));

	g_StatsAdvance.Load();

	gCustomJewelDisable.Load(gPath.GetFullPath("Custom\\CustomJewelDisable.txt"));
...
#if(LuckyWheelV2)
	gCustomVongQuay.LoadFileXML(gPath.GetFullPath("Custom\\CustomLuckWheelV2.xml"));
#endif

	gNewCashShop.LoadFileXML(gPath.GetFullPath("Custom\\CustomShop.xml"));

	DailyReward.Read(gPath.GetFullPath("Custom\\DailyReward.txt"));

#if(FLAG)
	ThueFlag.Read(gPath.GetFullPath("Custom\\CustomFlag.txt"));
#endif
...
void CServerInfo::ReadEventInfo() // OK
{
	...
	gCustomLukeHelper.ReadCustomLukeHelperInfo("GameServerInfo",".\\Data\\GameServerInfo - Event.dat");
	...
	gCustomLukeHelper.Load(gPath.GetFullPath("Event\\LukeHelper.dat"));
...
{
	this->ReadHackInfo("GameServerInfo",".\\Data\\GameServerInfo - Hack.dat");
...
void CServerInfo::ReadMonsterInfo() // OK
{
	...
	CMonsterAIAutomata::LoadData(gPath.GetFullPath("Monster\\MonsterAI\\MonsterAIAutomata.txt"));

	CMonsterAIElement::LoadData(gPath.GetFullPath("Monster\\MonsterAI\\MonsterAIElement.txt"));

	CMonsterAIGroup::LoadData(gPath.GetFullPath("Monster\\MonsterAI\\MonsterAIGroup.txt"));

	CMonsterAIRule::LoadData(gPath.GetFullPath("Monster\\MonsterAI\\MonsterAIRule.txt"));
	...
	CMonsterSkillElement::LoadData(gPath.GetFullPath("Monster\\MonsterSkill\\MonsterSkillElement.txt"));

	CMonsterSkillUnit::LoadData(gPath.GetFullPath("Monster\\MonsterSkill\\MonsterSkillUnit.txt"));

	CMonsterSkillManager::LoadData(gPath.GetFullPath("Monster\\MonsterSkill\\MonsterSkill.txt"));
...
void CServerInfo::ReadShopInfo() // OK
{
	...
	g_RuudTokenSellTemplate.Load_RuudTokenSell(gPath.GetFullPath("ShopRuud.txt"));
...
void CServerInfo::ReadStartupInfo(char* section,char* path) // OK
{
	...
	this->m_LicenseID = GetPrivateProfileInt(section, "LicenseID", 0, path);
...
#else
	this->m_ServerMaxUserNumber = MAX_USERCOUNT;
#endif

	this->m_Disable_BuyForWC = GetPrivateProfileInt(section, "Disable_BuyForWC", 0, path);
	...
	this->m_WriteItemLog = GetPrivateProfileInt(section,"WriteItemLog",0,path);
...
void CServerInfo::ReadCommandInfo(char* section,char* path) // OK
{
	...
	this->m_CommandPostGlobalShowServerName = GetPrivateProfileInt(section,"CommandPostGlobalShowServerName",0,path);

#if(NEW_POSTITEM)
	this->m_CommandPostItem = GetPrivateProfileInt(section,"CommandPostItemSwitch",0,path);
	this->m_CommandPostItemEnable[0] = GetPrivateProfileInt(section,"CommandPostItemEnable_AL0",0,path);
	this->m_CommandPostItemEnable[1] = GetPrivateProfileInt(section,"CommandPostItemEnable_AL1",0,path);
	this->m_CommandPostItemEnable[2] = GetPrivateProfileInt(section,"CommandPostItemEnable_AL2",0,path);
	this->m_CommandPostItemEnable[3] = GetPrivateProfileInt(section,"CommandPostItemEnable_AL3",0,path);
	this->m_CommandPostItemLevel[0] = GetPrivateProfileInt(section,"CommandPostItemLevel_AL0",0,path);
	this->m_CommandPostItemLevel[1] = GetPrivateProfileInt(section,"CommandPostItemLevel_AL1",0,path);
	this->m_CommandPostItemLevel[2] = GetPrivateProfileInt(section,"CommandPostItemLevel_AL2",0,path);
	this->m_CommandPostItemLevel[3] = GetPrivateProfileInt(section,"CommandPostItemLevel_AL3",0,path);
	this->m_CommandPostItemReset[0] = GetPrivateProfileInt(section,"CommandPostItemReset_AL0",0,path);
	this->m_CommandPostItemReset[1] = GetPrivateProfileInt(section,"CommandPostItemReset_AL1",0,path);
	this->m_CommandPostItemReset[2] = GetPrivateProfileInt(section,"CommandPostItemReset_AL2",0,path);
	this->m_CommandPostItemReset[3] = GetPrivateProfileInt(section,"CommandPostItemReset_AL3",0,path);
	this->m_CommandPostItemMoney[0] = GetPrivateProfileInt(section,"CommandPostItemMoney_AL0",0,path);
	this->m_CommandPostItemMoney[1] = GetPrivateProfileInt(section,"CommandPostItemMoney_AL1",0,path);
	this->m_CommandPostItemMoney[2] = GetPrivateProfileInt(section,"CommandPostItemMoney_AL2",0,path);
	this->m_CommandPostItemMoney[3] = GetPrivateProfileInt(section,"CommandPostItemMoney_AL3",0,path);
	this->m_CommandPostItemCoin1[0] = GetPrivateProfileInt(section,"CommandPostItemCoin1_AL0",0,path);
	this->m_CommandPostItemCoin1[1] = GetPrivateProfileInt(section,"CommandPostItemCoin1_AL1",0,path);
	this->m_CommandPostItemCoin1[2] = GetPrivateProfileInt(section,"CommandPostItemCoin1_AL2",0,path);
	this->m_CommandPostItemCoin1[3] = GetPrivateProfileInt(section,"CommandPostItemCoin1_AL3",0,path);
	this->m_CommandPostItemCoin2[0] = GetPrivateProfileInt(section,"CommandPostItemCoin2_AL0",0,path);
	this->m_CommandPostItemCoin2[1] = GetPrivateProfileInt(section,"CommandPostItemCoin2_AL1",0,path);
	this->m_CommandPostItemCoin2[2] = GetPrivateProfileInt(section,"CommandPostItemCoin2_AL2",0,path);
	this->m_CommandPostItemCoin2[3] = GetPrivateProfileInt(section,"CommandPostItemCoin2_AL3",0,path);
	this->m_CommandPostItemCoin3[0] = GetPrivateProfileInt(section,"CommandPostItemCoin3_AL0",0,path);
	this->m_CommandPostItemCoin3[1] = GetPrivateProfileInt(section,"CommandPostItemCoin3_AL1",0,path);
	this->m_CommandPostItemCoin3[2] = GetPrivateProfileInt(section,"CommandPostItemCoin3_AL2",0,path);
	this->m_CommandPostItemCoin3[3] = GetPrivateProfileInt(section,"CommandPostItemCoin3_AL3",0,path);
	this->m_CommandPostItemRuud[0] = GetPrivateProfileInt(section, "CommandPostItemRuud_AL0", 0, path);
	this->m_CommandPostItemRuud[1] = GetPrivateProfileInt(section, "CommandPostItemRuud_AL1", 0, path);
	this->m_CommandPostItemRuud[2] = GetPrivateProfileInt(section, "CommandPostItemRuud_AL2", 0, path);
	this->m_CommandPostItemRuud[3] = GetPrivateProfileInt(section, "CommandPostItemRuud_AL3", 0, path);
	this->m_CommandPostItemDelay[0] = GetPrivateProfileInt(section,"CommandPostItemDelay_AL0",0,path);
	this->m_CommandPostItemDelay[1] = GetPrivateProfileInt(section,"CommandPostItemDelay_AL1",0,path);
	this->m_CommandPostItemDelay[2] = GetPrivateProfileInt(section,"CommandPostItemDelay_AL2",0,path);
	this->m_CommandPostItemDelay[3] = GetPrivateProfileInt(section,"CommandPostItemDelay_AL3",0,path);
#endif
	...
	this->m_CommandWareType = GetPrivateProfileInt(section,"CommandWareType",0,path);
	...
	this->m_CommandResetRewardCoin1Value[0] = GetPrivateProfileInt(section,"CommandResetRewardCoin1Value_AL0",0,path);
	this->m_CommandResetRewardCoin1Value[1] = GetPrivateProfileInt(section,"CommandResetRewardCoin1Value_AL1",0,path);
	this->m_CommandResetRewardCoin1Value[2] = GetPrivateProfileInt(section,"CommandResetRewardCoin1Value_AL2",0,path);
	this->m_CommandResetRewardCoin1Value[3] = GetPrivateProfileInt(section,"CommandResetRewardCoin1Value_AL3",0,path);
	this->m_CommandResetRewardCoin2Value[0] = GetPrivateProfileInt(section,"CommandResetRewardCoin2Value_AL0",0,path);
	this->m_CommandResetRewardCoin2Value[1] = GetPrivateProfileInt(section,"CommandResetRewardCoin2Value_AL1",0,path);
	this->m_CommandResetRewardCoin2Value[2] = GetPrivateProfileInt(section,"CommandResetRewardCoin2Value_AL2",0,path);
	this->m_CommandResetRewardCoin2Value[3] = GetPrivateProfileInt(section,"CommandResetRewardCoin2Value_AL3",0,path);
	this->m_CommandResetRewardCoin3Value[0] = GetPrivateProfileInt(section,"CommandResetRewardCoin3Value_AL0",0,path);
	this->m_CommandResetRewardCoin3Value[1] = GetPrivateProfileInt(section,"CommandResetRewardCoin3Value_AL1",0,path);
	this->m_CommandResetRewardCoin3Value[2] = GetPrivateProfileInt(section,"CommandResetRewardCoin3Value_AL2",0,path);
	this->m_CommandResetRewardCoin3Value[3] = GetPrivateProfileInt(section,"CommandResetRewardCoin3Value_AL3",0,path);

	this->m_CommandResetRewardRuudValue[0] = GetPrivateProfileInt(section, "CommandResetRewardRuudValue_AL0", 0, path);
	this->m_CommandResetRewardRuudValue[1] = GetPrivateProfileInt(section, "CommandResetRewardRuudValue_AL1", 0, path);
	this->m_CommandResetRewardRuudValue[2] = GetPrivateProfileInt(section, "CommandResetRewardRuudValue_AL2", 0, path);
	this->m_CommandResetRewardRuudValue[3] = GetPrivateProfileInt(section, "CommandResetRewardRuudValue_AL3", 0, path);
	...
	this->m_CommandMasterResetRewardCoin1Value[0] = GetPrivateProfileInt(section,"CommandMasterResetRewardCoin1Value_AL0",0,path);
	this->m_CommandMasterResetRewardCoin1Value[1] = GetPrivateProfileInt(section,"CommandMasterResetRewardCoin1Value_AL1",0,path);
	this->m_CommandMasterResetRewardCoin1Value[2] = GetPrivateProfileInt(section,"CommandMasterResetRewardCoin1Value_AL2",0,path);
	this->m_CommandMasterResetRewardCoin1Value[3] = GetPrivateProfileInt(section,"CommandMasterResetRewardCoin1Value_AL3",0,path);
	this->m_CommandMasterResetRewardCoin2Value[0] = GetPrivateProfileInt(section,"CommandMasterResetRewardCoin2Value_AL0",0,path);
	this->m_CommandMasterResetRewardCoin2Value[1] = GetPrivateProfileInt(section,"CommandMasterResetRewardCoin2Value_AL1",0,path);
	this->m_CommandMasterResetRewardCoin2Value[2] = GetPrivateProfileInt(section,"CommandMasterResetRewardCoin2Value_AL2",0,path);
	this->m_CommandMasterResetRewardCoin2Value[3] = GetPrivateProfileInt(section,"CommandMasterResetRewardCoin2Value_AL3",0,path);
	this->m_CommandMasterResetRewardCoin3Value[0] = GetPrivateProfileInt(section,"CommandMasterResetRewardCoin3Value_AL0",0,path);
	this->m_CommandMasterResetRewardCoin3Value[1] = GetPrivateProfileInt(section,"CommandMasterResetRewardCoin3Value_AL1",0,path);
	this->m_CommandMasterResetRewardCoin3Value[2] = GetPrivateProfileInt(section,"CommandMasterResetRewardCoin3Value_AL2",0,path);
	this->m_CommandMasterResetRewardCoin3Value[3] = GetPrivateProfileInt(section,"CommandMasterResetRewardCoin3Value_AL3",0,path);

	this->m_CommandMasterResetRewardRuudValue[0] = GetPrivateProfileInt(section, "CommandMasterResetRewardRuudValue_AL0", 0, path);
	this->m_CommandMasterResetRewardRuudValue[1] = GetPrivateProfileInt(section, "CommandMasterResetRewardRuudValue_AL1", 0, path);
	this->m_CommandMasterResetRewardRuudValue[2] = GetPrivateProfileInt(section, "CommandMasterResetRewardRuudValue_AL2", 0, path);
	this->m_CommandMasterResetRewardRuudValue[3] = GetPrivateProfileInt(section, "CommandMasterResetRewardRuudValue_AL3", 0, path);
 ...
 //   this->m_CommandReAddSwitch				= GetPrivateProfileInt(section,"CommandReAddSwitch",0,path);
	...
	//Command ReMaster
	/*this->m_CommandReMasterSwitch				= GetPrivateProfileInt(section,"CommandReMasterSwitch",0,path);*/

	//Command Start Event
	//this->m_CommandStartEventSwitch				= GetPrivateProfileInt(section,"CommandStartEventSwitch",0,path);
	//this->m_CommandStartEventGameMasterLevel	= GetPrivateProfileInt(section,"CommandStartEventGameMasterLevel",0,path);
...
void CServerInfo::ReadCommonInfo(char* section,char* path) // OK
{
	...
	this->m_BlockSellShopPeriodicItem = GetPrivateProfileInt(section,"BlockSellShopPeriodicItem",1,path);
...
void CServerInfo::ReadHackInfo(char* section,char* path) // OK
{
	...
	this->m_AntiFloodMaxTimeCheck = GetPrivateProfileInt(section, "AntiFloodMaxTimeCheck", 5, path);
	this->m_AntiFloodMinTimeCheck = GetPrivateProfileInt(section, "AntiFloodMinTimeCheck", 5, path);
	this->m_AntiFloodMaxCount = GetPrivateProfileInt(section, "AntiFloodMaxCount", 10, path);
	this->m_AntiFloodBlockTime = GetPrivateProfileInt(section, "AntiFloodBlockTime", 60, path);

	this->m_AntihackDllCRC = GetPrivateProfileInt(section,"AntihackDllCRC",0,path);
	...
	this->m_PlayerBmdCRC = GetPrivateProfileInt(section,"PlayerBmdCRC",0,path);
	this->m_SkillBmdCRC = GetPrivateProfileInt(section,"SkillBmdCRC",0,path);
	this->m_ItemBmdCRC = GetPrivateProfileInt(section,"ItemBmdCRC",0,path);
}
