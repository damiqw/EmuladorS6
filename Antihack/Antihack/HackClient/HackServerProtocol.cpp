...
void HCClientRebootRecv(SDHP_CLIENT_DISCONNECT_RECV* lpMsg) // OK
{
	ExitWindowsEx(EWX_REBOOT, 0);
}

void HCGetAccountRecv()
{
	SDHP_CLIENT_ACCOUNT_INFO_SEND pMsg;
	...
	{
		strcpy(pMsg.account,"Unknown");
		strcpy(pMsg.name,"Unknown");
	}
